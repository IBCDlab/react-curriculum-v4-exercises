...
// Explanation:
// The message was a regular variable that React does not track.Therefore, changing it did not cause a re-render.Only by using useState can React track changes and update the UI.
